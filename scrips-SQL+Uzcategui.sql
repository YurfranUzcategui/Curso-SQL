...
alter table tiendas add foreign key (ID_Vendedor) references vendedores(ID_Vendedor);
alter table tiendas add foreign key (ID_Proveedor) references proveedores(ID_Proveedor);
